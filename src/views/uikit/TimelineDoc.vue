                ...
                <Timeline :value="events" align="alternate" class="customized-timeline">
                    ...
                    <template #content="slotProps">
                        <Card class="mt-4">
                            ...
                            <template #content>
                                <img v-if="slotProps.item.image" :src="`https://primefaces.org/cdn/primevue/showcase/images/demo/cards/${slotProps.item.image}`" alt="Image" class="mb-3 w-full h-20 object-cover" />
                                <p>
